...
public class FilaVetor<T> implements Fila<T> {
    ...
    public void encolher(){
        ...
        for (int whiteSpaces = 0; whiteSpaces < tamanho; whiteSpaces++) {
            novoInfo[whiteSpaces] = info[inicio];
            inicio = (inicio +1) % limite;
        }
    ...
    public FilaVetor<T> criarFilaConcatenada(FilaVetor<T> fila2){
        ...
        for (int i = 0; i < this.tamanho; i++) {
            ...
            indice = (inicio + 1) % filaConcatenada.limite;
        }
        ...
        System.out.println(filaConcatenada.tamanho);
